                                                        ...
                                                        <font size="4" color=black>
                                                            ...
                                                            <%
                                                                ...
                                                                try {
                                                                    ...
                                                                    ResultSet rs = st.executeQuery(" select productname,quantity,price from productinfo where productname='" + s1 + "'");
                                                            ...
                                                            <table color="blue" border=2 cellpadding=2 cellspacing=2>
                                                                <center>
                                                                    <th><tr>
                                                                            ...
                                                                            <td><font color="red">Stock</font></td>
                                                                    ...
                                                                    %>	
                                                                    <tr>
                                                                        <td><font color="red"><%=rs.getString(1)%></font></td><td><font color="red"><%=rs.getInt(2)%></font></td><td><font color="red"><%=rs.getInt(3)%></font></td>
